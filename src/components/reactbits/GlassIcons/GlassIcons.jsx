    ...
    >
      {items.map((item, index) => (
        <button
          ...
          className={`relative bg-transparent outline-none w-[4.5em] h-[4.5em] [perspective:24em] [transform-style:preserve-3d] group ${
            item.customClass || ""
          }`}
        >
          <span
          ...
          >
            <span
              className="m-auto w-[1.5em] h-[1.5em] flex items-center justify-center text-xl font-semibold text-white"
              aria-hidden="true"
            >
              {item.short}
            </span>
